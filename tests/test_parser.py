...
class TestParser:
    ...
    def test_popping_one_off_stack_of_one(
            self,
            parser_init,
            push_stack_one_str):
    ...
    def test_peak_top_of_stack_with_one_string(
            self,
            parser_init,
            push_stack_one_str):
    ...
    def test_list_parse_with_dict_as_elem(
            self,
            parser_init,
            push_stack_one_dict_one_str_num_elem):
    ...
    def test_list_parse_with_one_list_one_str_elem(
            self,
            parser_init,
            push_stack_one_list_one_str_elem):

        parser_init._stack_push_list_elem(parser_init._stack_pop())
        assert parser_init._stack_pop() == 'test-list-1'

    def test_list_parse_with_one_list_two_elem(
            self,
            parser_init,
            push_stack_one_list_two_str_elem):
    ...
    def test_dict_parse_with_list_as_elem(
            self,
            parser_init,
            push_stack_one_list_one_str_elem):
    ...
    def test_dict_parse_with_num_as_key(
            self,
            parser_init,
            push_stack_one_dict_one_str_num_elem):
    ...
    def test_dict_parse_with_one_dict_correct_key(
            self,
            parser_init,
            push_stack_one_dict_one_str_num_elem):

        value_list = parser_init._stack_all_key_values_in_dict(
            'dict1-key1', parser_init._stack_pop())
        assert value_list.pop() == 1

    def test_dict_parse_with_one_dict_incorrect_key(
            self,
            parser_init,
            push_stack_one_dict_one_str_num_elem):

        value_list = parser_init._stack_all_key_values_in_dict(
            'wrong', parser_init._stack_pop())
    ...
    def test_stack_trace_non_empty_stack(
            self,
            parser_init,
            push_stack_one_str):
